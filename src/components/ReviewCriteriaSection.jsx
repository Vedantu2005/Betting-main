      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            How We Review <br className="hidden md:block" /> Cricket Betting Platforms?
          </h2>
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-3xl font-bold text-gray-900">
                  Why You Can Trust <br /> 7Crickets Ratings?
                </h3>
              </div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                We never promote illegal or unlicensed platforms. Our picks are
                verified with user feedback and regulatory checks. So if you’re
                asking <span className="text-gray-900 italic font-medium">“Is betting on cricket legal in India?”</span> — the answer is yes,
                when you use licensed apps.
              </p>
