      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Top 10 <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Betting Apps</span> <br className="hidden md:block" /> in India for 2025
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            The definitive list of the most trusted, feature-rich, and user-friendly cricket betting apps available today.
          </p>
        </div>
