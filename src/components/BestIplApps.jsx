      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Best <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">IPL Betting Apps</span> <br /> for Real Money
          </h2>
          
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            The best IPL betting apps allow you to bet online on the famous IPL matches. Pick your favorite teams, predict the Man of the Match, and win real money on the go.
          </p>
        </div>
