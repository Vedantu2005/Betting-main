        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-gray-200  relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Simplify & Understand</h3>
                <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                  Our cricket betting suggestions simplify odds, markets, and match conditions. We give more than cricket betting tips in this guide; it’s about enhancing your <strong className="text-gray-900">understanding of the game</strong> in all its forms.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Passion & Analysis</h3>
                <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                  As you follow our daily updates, realise that each suggestion comes from <strong className="text-gray-900">serious analysis and game passion</strong>. Our goal is to improve your betting and make every match a deeper sports experience.
                </p>
              </div>
            </div>
          ...
          <div className="mt-12 text-center pt-8 border-t border-gray-100">
            <button className="inline-flex items-center gap-2 text-blue-600 font-bold hover:text-blue-800 transition-colors group text-lg">
              Ready to place your first bet? <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
