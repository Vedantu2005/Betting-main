        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Subscribe to Free <br /> Cricket Betting Tips
            </h2>
            
            <div className="h-1 w-20 bg-blue-600 mb-8 rounded-full"></div>
            
            <p className="text-lg text-gray-600 max-w-md leading-relaxed">
              Want to stay ahead in the world of online cricket betting? Join thousands of smart bettors getting daily insights delivered to their inbox.
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-2xl relative">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              Join India's Growing Cricket Betting Community
            </h3>

            <p className="text-gray-600 mb-8 leading-relaxed border-b border-gray-100 pb-6">
              Subscribe for daily match predictions, 96 cricket app news, and strategy updates. Get access to:
            </p>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start p-3 rounded-xl hover:bg-gray-50 transition-colors duration-300 cursor-default">
                ...
                <div className="text-lg text-gray-600">
                  Stake news for <span className="text-gray-900 font-bold">Indian cricket</span>
                </div>
              </li>
              ...
              <li className="flex items-start p-3 rounded-xl hover:bg-gray-50 transition-colors duration-300 cursor-default">
                ...
                <div className="text-lg text-gray-600">
                  Verified cricket bookies contacts (licensed)
                </div>
              </li>
            </ul>
