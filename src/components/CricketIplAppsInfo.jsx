        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed opacity-90 mb-6">
              Cricket and IPL betting applications are becoming very popular in India, offering fascinating ways to play your favourite sports online. The top apps combine real-time excitement with user-friendly designs.
            </p>
            
            <p className="text-lg text-gray-600 leading-relaxed opacity-90">
              Indian cricket fans can confidently wager on real-time matches using legal apps. These platforms make finding odds easier and are simple to download, making cricket, football, and other sports betting accessible to everyone.
            </p>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
               ...
               <p className="text-lg text-gray-600 leading-relaxed mb-6">
                 Cricket betting is a major trend in Indian online sports betting. India's most popular sport is cricket, and the IPL draws many bettors. <span className="text-gray-900 font-semibold">Live streaming</span> and <span className="text-gray-900 font-semibold">in-play betting</span> allow bettors to place bets while watching the game, increasing popularity.
               </p>
            </div>
            ...
            <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
               ...
               <p className="text-gray-600 text-sm leading-relaxed mb-4">
                 While cricket remains king, other sports are gaining traction due to increased exposure via TV and online channels.
               </p>
