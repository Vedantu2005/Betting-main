...
const BlogSidebar = () => {
    const recentPosts = [
        ...
        { slug: 'nz-vs-wi-tickets', title: 'New Zealand vs West Indies 5th T20I 2025 Tickets' },
        { slug: 'pak-vs-sa-tickets', title: 'Pakistan vs South Africa 3rd ODI 2025 Tickets' },
    ];
    ...
    return (
        <div className="mt-16 bg-white p-8 rounded-2xl border border-gray-200 shadow-sm flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-blue-600 text-sm font-bold uppercase tracking-wider mb-4">Cricket Analyst</p>
                <p className="text-gray-600 leading-relaxed text-sm opacity-90">
                    Known for his strong understanding of game stats and player behavior, Aiden Fletcher is an expert in cricket predictions. He studied Sports Analytics at the University of Oxford and has spent over 6 years analyzing player performance.
                </p>
            </div>
        </div>
    );
    ...
    return (
        <article className="prose prose-lg max-w-none text-gray-600">
            ...
            <ul className="space-y-4 list-none pl-0">
                ...
                <li className="flex gap-3">
                    <div className="mt-1.5 w-2 h-2 rounded-full bg-blue-600 flex-shrink-0"></div>
                    <span><strong>Batting Depth:</strong> Mushfiqur Rahim scored 12 centuries in Test cricket. They know how to bat in Asia very well.</span>
                </li>
            </ul>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6">Dhaka Test 2025 Betting Tips</h2>
