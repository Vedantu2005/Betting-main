        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-left">
            ...
            <h1 className="text-4xl md:text-4xl lg:text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
              Top Cricket Betting Apps in India <br />
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8 max-w-xl">
              Betting apps in India have revolutionized the internet gambling world. With cricket peaking during IPL seasons, these apps allow you to place <span className="text-gray-900 font-semibold">real-money bets</span>, check <span className="text-gray-900 font-semibold">live odds</span>, and enjoy secure payments directly from your smartphone.
            </p>
