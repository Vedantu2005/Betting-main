        ...
        <div>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Finance Your <span className="text-blue-600">Betting Journey</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto opacity-90">
              From funding your wallet to placing smart bets, follow these steps to manage your bankroll effectively.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FinanceStep 
              ...
              text="Choose preferred methods like UPI, credit cards, or e-wallets. Follow verification steps for added security."
            />
            <FinanceStep 
              icon={<PlayCircle size={24} />}
              title="Start Betting"
              text="Once your account is funded and balance reflects, you are ready to place your first wager instantly."
            />
            <FinanceStep 
              icon={<Trophy size={24} />}
              title="Choose Events"
              text="Select from football contests, horse races, or eSports. There are markets for everyone."
            />
            <FinanceStep 
              icon={<BarChart2 size={24} />}
              title="Analyze Stats"
              text="Use the app's team statistics and match history. This improves your prediction skills significantly."
            />
          </div>
        </div>
