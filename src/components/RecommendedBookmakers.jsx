      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            Our Most Recommended <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Cricket Bookmakers</span>
          </h2>
          
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            <p className="text-lg text-gray-600 mb-4 leading-relaxed">
              Here is the list of some new cricket betting sites picked on the basis of trust, offers, and user experience:
            </p>
            <p className="text-sm text-gray-500 opacity-90">
              These apps also offer best cricket betting tips Telegram channel access and support cricket formats legally. You can enjoy betting on sports and online casino and have fun.
            </p>
          </div>
        </div>
