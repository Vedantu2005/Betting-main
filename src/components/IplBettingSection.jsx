        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 text-left relative z-10">
            ...
            <div className="flex items-center gap-2 text-blue-600 mb-4 font-bold tracking-widest uppercase text-sm">
               <Trophy size={16} />
               <span>Cricket Carnival</span>
            </div>
            
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              IPL 2025 Betting Tips <br /> & Match Previews
            </h2>
            
            <p className="text-lg text-gray-600 mb-10 border-l-4 border-blue-600 pl-6">
              IPL is India’s biggest cricket carnival and betting event.
            </p>
            ...
            <div className="mb-10">
              ...
              <p className="text-lg text-gray-600 leading-relaxed pl-0 md:pl-14">
                Check our live blog for IPL 2025 games. Get daily insights, pitch reports, and odds movements.
              </p>
            </div>
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 group">
              <img 
                src="/team.png" 
                alt="IPL 2025 Captains and Trophy" 
