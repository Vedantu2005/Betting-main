        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-left">
            ...
            <h1 className="text-4xl md:text-4xl lg:text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
              Expert Cricket Betting <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                Tips & Predictions 2025
              </span>
            </h1>
            
            <p className="text-lg text-gray-600 leading-relaxed mb-8 border-l-4 border-blue-600 pl-6">
              Having the appropriate ideas and methods can help beginners and experts win bets. Online betting requires knowing odds, researching teams and players, and staying current on sports events and trends. Our expert tips analyze prior results, injuries, and weather to help you make informed judgments.
            </p>
